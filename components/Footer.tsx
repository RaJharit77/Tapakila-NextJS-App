...
import { FaCcMastercard, FaCcVisa, FaFacebookMessenger, FaPaypal } from 'react-icons/fa';
import { FaFacebook, FaInstagram, FaLinkedinIn, FaWhatsapp } from 'react-icons/fa6';
            ...
            <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
                ...
                <div className="flex flex-wrap justify-center lg:justify-end space-x-6 items-center mb-6 lg:mb-0">
                    <a
                        ...
                        className="text-blancCasse hover:text-orMetallique transition-all duration-300 hover:scale-110 hover:rotate-6"
                        target="_blank"
