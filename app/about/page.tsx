    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center px-4 py-32">
                <h1 className="text-5xl font-bold mb-6 tracking-wider leading-tight text-bleuNuit">
                    À propos de Tapakila
                </h1>

                <p className="text-lg leading-8 mb-8 text-blancGlacialNeutre">
                ...
                <div className="mt-12" data-aos="fade-right">
                    ...
                    <p className="text-lg leading-7 mb-6 text-blancGlacialNeutre">
                    ...
                    <p className="text-lg leading-7 text-blancGlacialNeutre">
                ...
                <div className="mt-12" data-aos="fade-left">
                    ...
                    <p className="text-lg leading-7 mb-6 text-blancGlacialNeutre">
                        Tapakila a été fondé en 2025 par une équipe de passionnés de technologie et d&apos;événements. Inspirés par les défis rencontrés lors de la réservation de billets, nous avons décidé de créer une solution qui simplifie ce processus.
                    </p>
